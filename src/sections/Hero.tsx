  ...
  <section ref = {heroRef} className="pt-8 pb-20 md:pt-5 md:pb-10 bg-[radial-gradient(ellipse_200%_100%_at_bottom_left,_#183EC2,_#EAEEFE_100%)] overflow-x-clip"> 
    <div className = "container">
      ...
      <p className="text-xl text-[#010D3E] tracking-tighter mt-6">
        Celebrate a joy of accomplishment with an app designed to trak your progress, 
        motivate your efforts, and celebrate your success.
      </p>
      <div className = "flex gap-1 items-center mt-[30px]">
       <button className="btn btn-primary">Get for free</button>
       <button className="btn btn-text flex items-center gap-1 min-w-max">
       <span className="block">Learn more</span>
        <ArrowIcon className="h-5 w-5 inline-block text-black" />
        </button>
      </div>
      </div>
      <div className = "mt-20 md:mt-0 md:h-[648px] md:flex-1 relative ">
       ...
       {/* parallax effect for -> cylinder and noodle image  with the help of translateY which we have defined earlier on*/}
