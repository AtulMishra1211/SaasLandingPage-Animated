        ...
        <div className="flex flex-col gap-6 items-center mt-10 lg:flex-row lg:items-end lg:justify-center">
          {pricingTiers.map(
            ...
            <div key={title} className={twMerge("card", inverse===true && 'border-black bg-black text-white')}>
              ...
              <h3 className={twMerge("text-lg font-vold text-black/50", inverse===true && "text-white/60")}>{title}</h3>
              
              {/* when popular is set to true then only it will show! */}
              {popular===true && (
              ...
              className="bg-[linear-gradient(to_right,#DD7DDF,#E1CD86,#BBCB92,#71C2EF,#3BFFFF,#DD7DDF,#E1CD86,#BBCB92,#71C2EF,#3BFFFF)] [background-size:200%] bg-clip-text text-transparent inline-block">
              Popular
              </motion.span>
              </div>
